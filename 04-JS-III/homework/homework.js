...
function dePalabrasAFrase(palabras) {
  ...
  st=st+palabras[palabras.length-1]
  return st
}
...
function todosIguales(arreglo) {
  ...
  for(let i=0;i<arreglo.length;i++)
  {
    if(arreglo[0]!=arreglo[i]){check=false}
  }
  return check
} 
...
function mesesDelAño(array) {
  ...
  if(m[0]== "Marzo" &&m[1]=="Noviembre"&&m[2]=="Enero")
  {return m}
